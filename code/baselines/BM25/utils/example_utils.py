...
class ExampleMetadata:
    ...
    relevance_ratings: typing.Optional[typing.Dict[str, typing.Sequence[str]]] = None
    evidence_ratings: typing.Optional[typing.Dict[str, typing.Sequence[str]]] = None
    # The nested value is a map from query substring to document substring.
    attributions: typing.Optional[typing.Dict[str, typing.Sequence[typing.Dict[str, str]]]] = None
