#!/bin/bash
#SBATCH --job-name=e5-base-v2
#SBATCH --output=outputs/logs/e5-base-v2-%j.out
#SBATCH --error=outputs/logs/e5-base-v2-%j.err
...
OUTPUT_FILE="${OUTPUT_FILE:-./outputs/runs/e5-base-v2/results_$(date +%Y%m%d_%H%M%S).jsonl}"
...
echo "=========================================="
echo "Starting E5-base-v2 inference (e5-base-v2_main.py)"
...
CMD="python code/baselines/e5-base-v2/e5-base-v2_main.py \
